...
$mhs = queryMatkul("SELECT * FROM matkul WHERE id_mk = $id")[0];
        ...
        <div class="form box m-5">
            ...
            <div class="card m-4 p-4">
                ...
                <div class="px-4 d-blok">
                    ...
                    <pre class="text-secondary">Nama Mata Kuliah :  <?= $mhs["matkul"]; ?></pre>
                    <pre class="text-secondary">Kode Mata Kuliah :  <?= $mhs["kdmk"]; ?></pre>
                    <pre class="text-secondary">SKS              :  <?= $mhs["sks"]; ?></pre>
                    <a href="/tugas/matkul" class="btn btn-danger">Balik</a>
                </div>
                </div>
            </div>
        </div>
